...
export default function Home() {
  ...
  const completeTransaction = (finalTotal, txnId, authCode) => {
    setSuccessDetails({
      total: finalTotal,
      txnId: txnId || 'TXN-' + Math.floor(1000000000 + Math.random() * 9000000000),
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.mainLayout}>
        {/* Left Sidebar (Receipt) — hidden on Process Return */}
        ...
        <div style={styles.modalOverlay}>
          <div style={styles.ageModalCard}>
            ...
            <div style={styles.ageModalFooter}>
              ...
              <button style={styles.ageBtnVerify} onClick={() => setIsAgeVerificationModalOpen(false)}>Verify Customer</button>
            </div>
          </div>
        </div>
      )}
